...
- (id)initWithMessage:(NSString*)string {
	...
	CGSize size = [message sizeWithFont:[UIFont boldSystemFontOfSize:_MessageViewFont] constrainedToSize:CGSizeMake(320, 120)];
...
- (void)drawRect:(CGRect)rect {
	...
	[message drawInRect:messageRect withFont:[UIFont boldSystemFontOfSize:_MessageViewFont]];
}
