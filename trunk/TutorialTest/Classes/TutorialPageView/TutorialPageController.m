...
- (void)viewWillAppear:(BOOL)animated {
	...
	UIBarButtonItem *done = [[[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Done", nil) style:UIBarButtonItemStyleBordered target:self action:@selector(done:)] autorelease];
